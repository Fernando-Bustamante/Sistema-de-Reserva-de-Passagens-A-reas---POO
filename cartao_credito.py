...
class GerenciadorCartaoDeCredito:
    ...
    def _adicionar_cartao(self, numero_cartao: str, cpf: str, operacoes: List[Dict[str, Union[str, float]]] = None) -> None:
        ...
        try:
            with open(self.arquivo_cartoes, 'r') as file:
                ...
                for linha in linhas:
                    ...
                    self._adicionar_cartao(numero_cartao, cpf, operacoes)
